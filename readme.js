...
;!function(t) {
    ...
    r.prototype.use = function(t, r, l) {
        function c(t, e) {
            ...
            ("load" === t.type || r.test((t.currentTarget || t.srcElement).readyState)) && (n.modules[d] = e,
            y.removeChild(m),
            function o() {
        ...
        function s() {
            l.push(layui[d]),
            t.length > 1 ? p.use(t.slice(1), r, l) : "function" == typeof r && function() {
        ...
        0 === t.length || layui["layui.all"] && u[d])
            return s(),
            p;
        ...
        n.modules[d])
            ...
            y.appendChild(m),
            !m.attachEvent || m.attachEvent.toString && m.attachEvent.toString().indexOf("[native code") < 0 || i ? m.addEventListener("load", function(t) {
                c(t, h)
...
!function() {
    ...
    n.position = function(t, r, o) {
        if (r) {
            ...
            p + u + l > s() && (i.top > u + l ? p = i.top - u - 2 * l : "right" === o.clickType && (p = s() - u - 2 * l,
            p < 0 && (p = 0)));
            var h = o.position;
            if (h && (r.style.position = h),
            r.style.left = f + ("fixed" === h ? 0 : a(1)) + "px",
            r.style.top = p + ("fixed" === h ? 0 : a()) + "px",
            !n.hasScrollbar()) {
...
!function(e) {
    ...
    v.prototype.calendar = function(e, t, a) {
        ...
        "time" === d.type ? s.setBtnStatus("时间", lay.extend({}, s.systemDate(), s.startTime), lay.extend({}, s.systemDate(), s.endTime)) : s.setBtnStatus(!0)) : (s.listYM = [[m.year, m.month + 1]],
        s.list(d.type, 0))),
        ...
        var a = this
          ...
          , o = {
            ...
            confirm: function() {
                if (n.range) {
                    if (lay(e).hasClass(s))
                        return a.hint("time" === n.type ? l.timeout.replace(/日期/g, "时间") : l.timeout)
    ...
    var t = layui.$
      , i = {
        ...
        timeAgo: function(e, t) {
            ...
            a[0].join("-") + " " + a[1].join(":")) : n >= 864e5 ? (n / 1e3 / 60 / 60 / 24 | 0) + "天前" : n >= 36e5 ? (n / 1e3 / 60 / 60 | 0) + "小时前" : n >= 18e4 ? (n / 1e3 / 60 | 0) + "分钟前" : n < 0 ? "未来" : "刚刚"
        },
        digit: function(e, t) {
            var i = "";
            e = String(e),
